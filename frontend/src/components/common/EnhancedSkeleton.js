...
// ---------------------------------------------------------------------------
// Additional skeleton types merged from LoadingSkeleton (legacy file archived)
// ---------------------------------------------------------------------------

/** Generic card skeleton (title + body text + image) */
...
/** Simple list-item skeleton (avatar + two text lines) */
...
/** Full profile-page skeleton (cover, avatar, stats, bio) */
...
/** Feed / social-post skeleton (author header + text + image + action row) */
...
/** Simple avatar + name row skeleton */
export function AvatarSkeleton({ count = 1 }) {
  return (
    <>
      {Array.from({ length: count }).map((_, i) => (
